...
# =============================================================================
# API路由 - 添加这些路由到web_interface.py中
# =============================================================================
...
def predict_ad():
    ...
    try:
        ...
        # 模拟预测结果
        if data.get('simulate_ad', False):
            ad_probability = np.random.uniform(0.6, 0.9)  # AD患者概率较高
        else:
            ad_probability = np.random.uniform(0.1, 0.4)  # 正常人概率较低

        prediction_label = 1 if ad_probability > 0.5 else 0
